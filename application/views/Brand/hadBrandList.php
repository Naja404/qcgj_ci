			...
			<div class="main-container-inner">
				...
				<div class="main-content">
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<form method="get" action="<?php echo site_url('Brand/hadBrandList');?>">
														...
														<td>
															<div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
																...
																<!-- <button class="btn btn-xs btn-info"> -->
																	<a href="<?php echo site_url('Brand/editBrand').'?brandId='.strEncrypt($v->id).'&p='.$this->input->get('p').'&had=1005';?>"><i class="icon-edit bigger-120"></i>编辑</a>
																<!-- </button> -->
