<?php $this->load->view('Public/header');?>
	...
	<body>
						...
						<div class="row">
							...
							<div class="col-xs-12">
								<div class="row">
									...
									<form role="form" id="editTravel-form">
									...
									<div class="clearfix form-actions">
										<div class="col-md-offset-3 col-md-9">
											<button class="btn btn-info" type="button" onclick="subEditTravel()">
		...
		function subEditTravel(){
				$.ajax({
					type:"POST",
					url:"<?php echo site_url('HongQiao/editTravel').'?id='.$this->input->get('id');?>",
					data:$('#editTravel-form').serialize(),
					success:function(data){
						if (data.status == '0') {
							window.location.href = "<?php echo site_url('HongQiao/travelList').'?p='.$this->input->get('p');?>";
							return true;
						}
