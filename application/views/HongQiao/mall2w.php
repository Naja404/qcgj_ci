														...
														<td>
															<div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
																...
																<!-- <button class="btn btn-xs btn-info"> -->
																	<a href="<?php echo site_url('HongQiao/editMall2w').'?id='.strEncrypt($v->id).'&p='.$this->input->get('p').'&mark='.$v->id;?>"><i class="icon-edit bigger-120">编辑</i></a>
																<!-- </button> -->
