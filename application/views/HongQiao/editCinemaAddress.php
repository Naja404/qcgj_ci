<?php $this->load->view('Public/header');?>
	...
	<body>
				...
				<div class="main-content">
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li>
								<a ><?php echo $this->lang->line('TITLE_HONGQIAO');?></a>
							</li>
							<li class="active">编辑电影院地址</li>
						</ul>
							...
							<div class="col-xs-12">
								<form class="form-horizontal" role="form" id="editMall-form">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="mallName"> 电影院 </label>
		...
		function subEditMall(){
			...
			$.ajax({
				type:"POST",
				url:"<?php echo site_url('HongQiao/editCinemaAddress').'?id='.$this->input->get('id');?>",
