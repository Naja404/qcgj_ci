<?php $this->load->view('Public/header');?>
	...
	<body>
						...
						<div class="row">
							...
							<div class="col-xs-12">
								<div class="row">
									...
									<form role="form" id="editCinema-form">
											...
											<table id="rolelist-table" class="table table-striped table-bordered table-hover">
												...
												<tbody>
													...
													<tr>
														...
														<td>
															<img src="<?php echo config_item('shop_image_url').'uploadtemp/movie/'.$v;?>">
														</td>
													</tr>
													<?php endforeach;?>
													<tr>
									...
									<div class="clearfix form-actions">
										<div class="col-md-offset-3 col-md-9">
											<button class="btn btn-info" type="button" onclick="subEditCinema()">
		...
		function subEditCinema(){
				$.ajax({
					type:"POST",
					url:"<?php echo site_url('HongQiao/editCinema').'?id='.$this->input->get('id');?>",
					data:$('#editCinema-form').serialize(),
					success:function(data){
						if (data.status == '0') {
							window.location.href = "<?php echo site_url('HongQiao/cinemaList').'?p='.$this->input->get('p');?>";
							return true;
						}
