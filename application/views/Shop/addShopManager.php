				...
				<div class="main-content">
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li class="active"><?php echo $this->lang->line('TEXT_TITLE_ADD_SHOPMANAGER');?></li>
						</ul>
							...
							<div class="col-xs-12">
								<form class="form-horizontal" role="form" id="addManagerForm">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="fieldMagerName"> <?php echo $this->lang->line('TEXT_MANGER_NAME');?> </label>

										<div class="col-sm-9">
											<div class="clearfix">
											<input type="text" id="fieldMagerName" name="managerName" placeholder="<?php echo $this->lang->line('TEXT_ENTER_MANAGER_NAME');?>" class="col-xs-10 col-sm-5" maxlength="32" />
											</div>
										</div>
									</div>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="fieldPasswd"> <?php echo $this->lang->line('TEXT_PASSWORD');?> </label>

										<div class="col-sm-9">
											<div class="clearfix">
											<input type="password" id="fieldPasswd" name="passwd" placeholder="<?php echo $this->lang->line('TEXT_ENTER_PASSWORD');?>" class="col-xs-10 col-sm-5" maxlength="20"/>
											</div>
										</div>
									</div>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="fieldConfirmPasswd"> <?php echo $this->lang->line('TEXT_CONFIRM_PASSWORD');?> </label>

										<div class="col-sm-9">
											<div class="clearfix">
											<input type="password" id="fieldConfirmPasswd" name="confirmPasswd" placeholder="<?php echo $this->lang->line('TEXT_ENTER_PASSWORD_AGAIN');?>" class="col-xs-10 col-sm-5" maxlength="20" />
											</div>
										</div>
									</div>
