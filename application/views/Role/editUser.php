							...
							<div class="col-xs-12">
								<form class="form-horizontal" role="form" id="addRoleUser-form">
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="roleUsername" id="roleUsername" placeholder="<?php echo $this->lang->line('PLACEHOLDER_USERNAME');?>" value="<?php echo $detail->userName;?>"/>
										</div>
									</div>

									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="passwd"> 旧密码 </label>

										<div class="col-sm-9">
											<input type="password" name="passwd" id="passwd" placeholder="请输入旧密码"/>
										</div>
									</div>

									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="passwd"> 新密码 </label>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="confirmPasswd"> 确认旧密码 </label>

										<div class="col-sm-9">
											<input type="password" name="confirmPasswd" id="confirmPasswd" placeholder="请再次输入新密码"/>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<select name="role_id" id="roleIdSelect">
												...
												<option value="<?php echo $v->role_id;?>" <?php echo $v->role_id == $detail->role_id ? 'selected' : '';?>>
													<?php echo $v->name;?>
												</option>
												<?php endforeach;?>
											</select>
									...
									<div class="form-group" style="<?php echo isset($detail->brandName) || !empty($detail->brandName) ? '' : 'display:none;';?>" id="brandDiv">
										<label class="col-sm-3 control-label no-padding-right" for="brandSelect"><?php echo $this->lang->line('TEXT_BRAND');?></label>
										<div class="col-sm-9">
											<input type="text" name="brandName" id="brandName" value="<?php echo isset($detail->brandName) || !empty($detail->brandName) ? $detail->brandName : '';?>" placeholder="<?php echo $this->lang->line('TEXT_INPUT_BRAND_NAME');?>" />
										</div>
									</div>
									...
									<div class="clearfix form-actions">
										<div class="col-md-offset-3 col-md-9">
											...
											&nbsp; &nbsp; &nbsp;
											<button class="btn" onclick="backList();">
